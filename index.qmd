...
The evidence is not credible. The funnel plot and the Egger regression test indicate a publication bias. The risk of bias was not satisfactory for 19 out of the 22 included studies. Using the GRADE criteria the quality of the evidence ranges from very low to low. Altogether more high-quality studies need to be conducted before conclusive assertions can be made.The meta-analysis suggest that reported effect sizes may be inflated to a large extent.
